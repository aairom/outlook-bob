...
1. ***\*Preferred — opens Outlook desktop app:\****
  ...
  \```
  [outlook://open?messageId=](outlook://open?messageId=)<X-Graph-Message-ID>
  \```
...
3. ***\*Last resort:\**** `[outlook://open?messageId=](outlook://open?messageId=)<url-encoded Message-ID>`
...
\```json
{
 “<link_col_id>“:   { “url”: “[outlook://open?messageId=](outlook://open?messageId=)<X-Graph-Message-ID>“, “text”: “Ouvrir dans Outlook” },
